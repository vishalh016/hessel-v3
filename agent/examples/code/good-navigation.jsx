        ...
        <div className={`w-full min-h-screen transition-colors duration-300 ${isDark ? 'bg-gray-900' : 'bg-gray-50'
            ...
            >
                ...
                <motion.button
                    ...
                    whileTap={{ scale: 0.9 }}
                    onClick={() => setIsOpen(false)}
                    className={`absolute top-6 right-6 p-2 rounded-full transition-colors ${isDark
                        ...
                        {menuItems.map((item, i) => (
                            ...
                            >
                                <a
                                    href={item.href}
                                    onClick={() => setIsOpen(false)}
                                    className={`flex items-center space-x-4 p-4 rounded-lg transition-all ${isDark
            ...
            <main className="relative z-10 px-6 py-12 max-w-4xl mx-auto">
                <motion.div
                    ...
                    className={`p-8 rounded-2xl shadow-xl ${isDark ? 'bg-gray-800 text-white' : 'bg-white text-gray-900'
                        }`}
                >
                ...
                <motion.div
                    ...
                    className={`mt-8 p-8 rounded-2xl shadow-xl ${isDark ? 'bg-gray-800 text-white' : 'bg-white text-gray-900'
                        }`}
                >
